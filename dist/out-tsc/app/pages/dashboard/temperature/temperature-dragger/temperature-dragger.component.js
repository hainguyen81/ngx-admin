...
let TemperatureDraggerComponent = TemperatureDraggerComponent_1 = class TemperatureDraggerComponent {
    constructor(location, locationStrategy) {
        ...
        this.step = 0.1;
        this.power = new EventEmitter();
        this.off = false;
        this.svgControlId = uniqueId++;
        this.scaleFactor = 1;
    ...
    calculateGradientConePaths(angleStep) {
    ...
    recalculateValue(event, allowJumping = false) {
...
tslib_1.__decorate([
    Input(),
    tslib_1.__metadata("design:type", Object)
], TemperatureDraggerComponent.prototype, "thumbBg", void 0);
tslib_1.__decorate([
    Input(),
    tslib_1.__metadata("design:type", Object)
], TemperatureDraggerComponent.prototype, "thumbBorderColor", void 0);
tslib_1.__decorate([
    Input(),
    tslib_1.__metadata("design:type", Object)
...
export { TemperatureDraggerComponent };
