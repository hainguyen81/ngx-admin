...
import {IWarehouseAdjust} from '../../../@core/data/warehouse.adjust';

@Injectable()
export class WarehouseAdjustDbService extends AbstractDbService<IWarehouseAdjust> {
    ...
    getAll(): Promise<IWarehouseAdjust[]> {
        return super.getAll();
    }
