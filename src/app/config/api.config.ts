...
export const MODULE_CODES: any = {
    ...
    WAREHOUSE_SETTINGS_GENERAL: API.warehouse.children.settings.children.warehouseSettings.code.call(undefined),
    WAREHOUSE_SETTINGS_STORAGE: API.warehouse.children.settings.children.warehouseStorage.code.call(undefined),
    WAREHOUSE_SETTINGS_CATEGORY: API.warehouse.children.settings.children.warehouseCategory.code.call(undefined),
    WAREHOUSE_FEATURES: API.warehouse.children.features.code.call(undefined),
    WAREHOUSE_FEATURES_ITEM: API.warehouse.children.features.children.warehouseItem.code.call(undefined),
};
