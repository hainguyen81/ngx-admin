 ...
 */
@Component({
    selector: 'ngx-select-ex-app-module-general-settings-system-customer-type',
    templateUrl: '../../../formly/formly.select.ex.field.component.html',
    styleUrls: ['../../../formly/formly.select.ex.field.component.scss'],
})
export class SystemCustomerTypeFormlySelectExFieldComponent
    ...
    /**
     * Create a new instance of {SystemCustomerTypeFormlySelectExFieldComponent} class
