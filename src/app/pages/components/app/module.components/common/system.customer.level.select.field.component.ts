 ...
 */
@Component({
    selector: 'ngx-select-2-app-module-general-settings-system-customer-level',
    templateUrl: '../../../formly/formly.select.field.component.html',
    styleUrls: ['../../../formly/formly.select.field.component.scss'],
})
export class SystemCustomerLevelFormlySelectFieldComponent
    ...
    /**
     * Create a new instance of {SystemCustomerLevelFormlySelectFieldComponent} class
