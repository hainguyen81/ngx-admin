...
import {GeneralSettingsFormlySelectExFieldComponent,} from './general.settings.select.ex.field.component';

/**
 * Custom module formly field for selecting warehouse settings
 */
@Component({
    selector: 'ngx-select-ex-app-module-general-settings-warehouse',
    templateUrl: '../../../formly/formly.select.ex.field.component.html',
    styleUrls: ['../../../formly/formly.select.ex.field.component.scss'],
})
export class GeneralWarehouseSettingsFormlySelectExFieldComponent
    ...
    /**
     * Create a new instance of {GeneralWarehouseSettingsFormlySelectExFieldComponent} class
