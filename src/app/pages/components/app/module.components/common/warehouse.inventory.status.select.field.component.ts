...
} from './general.warehouse.settings.select.field.component';

/**
 * Custom module formly field for selecting general warehouse inventory status settings
 */
@Component({
    selector: 'ngx-select-2-app-module-general-settings-warehouse-inventory-status',
    templateUrl: '../../../formly/formly.select.field.component.html',
    styleUrls: ['../../../formly/formly.select.field.component.scss'],
})
export class WarehouseInventoryStatusFormlySelectFieldComponent
    ...
    /**
     * Create a new instance of {WarehouseInventoryStatusFormlySelectFieldComponent} class
