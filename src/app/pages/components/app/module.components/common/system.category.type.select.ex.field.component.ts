...
/**
 * Custom module formly field for selecting general system category type settings
 */
@Component({
    selector: 'ngx-select-ex-app-module-general-settings-system-category-type',
    templateUrl: '../../../formly/formly.select.ex.field.component.html',
    styleUrls: ['../../../formly/formly.select.ex.field.component.scss'],
})
export class SystemCategoryTypeFormlySelectExFieldComponent
