 ...
 */
@Component({
    selector: 'ngx-select-2-app-module-general-settings-warehouse-settings-type',
    templateUrl: '../../../formly/formly.select.field.component.html',
    styleUrls: ['../../../formly/formly.select.field.component.scss'],
})
export class WarehouseSettingsTypeFormlySelectFieldComponent
    ...
    /**
     * Create a new instance of {WarehouseSettingsTypeFormlySelectFieldComponent} class
