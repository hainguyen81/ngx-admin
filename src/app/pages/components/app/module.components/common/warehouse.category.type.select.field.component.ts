 ...
 */
@Component({
    selector: 'ngx-select-2-app-module-general-settings-warehouse-category-type',
    templateUrl: '../../../formly/formly.select.field.component.html',
    styleUrls: ['../../../formly/formly.select.field.component.scss'],
})
export class WarehouseCategoryTypeFormlySelectFieldComponent
    ...
    /**
     * Create a new instance of {WarehouseCategoryTypeFormlySelectFieldComponent} class
