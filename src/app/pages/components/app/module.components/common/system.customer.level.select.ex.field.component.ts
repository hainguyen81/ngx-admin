...
import {GeneralSystemSettingsFormlySelectExFieldComponent,} from './general.system.settings.select.ex.field.component';
import BUILTIN_CODES = CommonConstants.COMMON.BUILTIN_CODES;

/**
 * Custom module formly field for selecting general system customer level settings
 */
@Component({
    selector: 'ngx-select-ex-app-module-general-settings-system-customer-level',
    templateUrl: '../../../formly/formly.select.ex.field.component.html',
    styleUrls: ['../../../formly/formly.select.ex.field.component.scss'],
})
export class SystemCustomerLevelFormlySelectExFieldComponent
    ...
    protected get dataIndexKey(): IDBKeyRange {
        return IDBKeyRange.only([this.moduleCode, BUILTIN_CODES.CUSTOMER_LEVEL.code]);
    }
    ...
    /**
     * Create a new instance of {SystemCustomerLevelFormlySelectExFieldComponent} class
