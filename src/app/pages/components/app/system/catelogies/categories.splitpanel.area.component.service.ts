...
/**
 * Categories split-pane area component service support for rendering/loading component dynamically, etc.
 */
@Injectable()
export class CategoriesSplitPaneAreaComponentService
