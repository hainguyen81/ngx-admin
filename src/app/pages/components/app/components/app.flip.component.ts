...
import {BaseFlipComponent} from '../../flip/base.flip.component';
...
@Component({
    selector: 'ngx-flip-app',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: '../../flip/flip.component.html',
    styleUrls: ['../../flip/flip.component.scss', './app.flip.component.scss'],
})
export class AppFlipComponent<D extends DataSource,
    TB extends AppToolbarComponent<D>,
    F extends AbstractComponent,
    B extends AbstractComponent>
    extends BaseFlipComponent<D>
        ...
        switch (action.id) {
            ...
            case ACTION_BACK:
                if (this.isDataChanged) {
                    ...
                    const confirmationSubscription: Subscription = this.getConfirmPopup().show(popupConfig)
                    .subscribe(value => {
                        if (value) {
                            this.doBack();
                            this.flipped = false;
                        }
                        PromiseUtils.unsubscribe(confirmationSubscription);
                    });
    ...
    private createFlipComponents(): void {
        ...
        const _this: AppFlipComponent<D, TB, F, B> = this;
