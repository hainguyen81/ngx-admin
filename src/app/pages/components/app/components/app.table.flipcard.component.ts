...
export const APP_TABLE_FLIPCARD_TOOLBAR_COMPONENT_TYPE_TOKEN: InjectionToken<Type<AppToolbarComponent<any>>>
...
export const APP_TABLE_FLIPCARD_TABLE_COMPONENT_TYPE_TOKEN: InjectionToken<Type<AppSmartTableComponent<any>>>
...
export const APP_TABLE_FLIPCARD_BACKWARD_COMPONENT_TYPE_TOKEN: InjectionToken<Type<AbstractComponent>>
...
/**
 * Application table flip-card component base on {NbFlipCardComponent}
...
@Component({
    ...
    styleUrls: [
        ...
        './app.table.flipcard.component.scss',
    ],
})
export class AppTableFlipcardComponent<T extends IModel, D extends DataSource,
    TB extends AppToolbarComponent<D>,
    F extends AppSmartTableComponent<D>,
    B extends AbstractComponent>
    extends AppFlipcardComponent<D, TB, F, B>
    ...
    constructor(@Inject(DataSource) dataSource: D,
                ...
                @Inject(APP_TABLE_FLIPCARD_TOOLBAR_COMPONENT_TYPE_TOKEN) toolbarComponentType?: Type<TB> | null,
                @Inject(APP_TABLE_FLIPCARD_TABLE_COMPONENT_TYPE_TOKEN) tableComponentType?: Type<F> | null,
                @Inject(APP_TABLE_FLIPCARD_BACKWARD_COMPONENT_TYPE_TOKEN) backComponentType?: Type<B> | null) {
    ...
    ngAfterViewInit(): void {
        ...
        // register front component event listeners
    ...
    private registerFrontComponentListeners(): void {
        const component: F = this.frontComponent;
