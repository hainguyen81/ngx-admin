...
export const APP_TABLE_FLIPCARD_FORM_TOOLBAR_COMPONENT_TYPE_TOKEN: InjectionToken<Type<AppToolbarComponent<any>>>
...
export const APP_TABLE_FLIPCARD_FORM_TABLE_COMPONENT_TYPE_TOKEN: InjectionToken<Type<AppSmartTableComponent<any>>>
...
export const APP_TABLE_FLIPCARD_FORM_FORM_COMPONENT_TYPE_TOKEN: InjectionToken<Type<AppFormlyComponent<any, any>>>
...
/**
 * Application table/form flip-card component base on {NbFlipCardComponent}
...
export class AppTableFlipcardFormComponent<T extends IModel, D extends DataSource,
    TB extends AppToolbarComponent<D>,
    F extends AppSmartTableComponent<D>,
    B extends AppFormlyComponent<T, D>>
    extends AppTableFlipcardComponent<T, D, TB, F, B> {
    ...
    constructor(@Inject(DataSource) dataSource: D,
                ...
                @Inject(APP_TABLE_FLIPCARD_FORM_TOOLBAR_COMPONENT_TYPE_TOKEN) toolbarComponentType?: Type<TB> | null,
                @Inject(APP_TABLE_FLIPCARD_FORM_TABLE_COMPONENT_TYPE_TOKEN) tableComponentType?: Type<F> | null,
                @Inject(APP_TABLE_FLIPCARD_FORM_FORM_COMPONENT_TYPE_TOKEN) formComponentType?: Type<B> | null) {
