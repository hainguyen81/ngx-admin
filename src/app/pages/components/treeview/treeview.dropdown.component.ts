...
/**
 * Base tree-view component base on {BaseNgxDropdownTreeviewComponent}
 */
@Component({
...
export class NgxDropdownTreeviewComponent extends BaseNgxDropdownTreeviewComponent<DataSource> {
